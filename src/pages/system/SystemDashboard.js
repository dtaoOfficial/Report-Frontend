...
const SystemDashboard = () => {
  ...
  return (
    ...
    >
      ...
      >
        System Department Dashboard
      </motion.h1>

      <p className="text-gray-700 text-lg">
        Welcome <span className="font-semibold">{user?.fullName || 'System User'}</span> 👋
      </p>
      ...
      >
        You can verify and forward reports from here.
      </motion.p>
      ...
      >
        ...
        <p className="text-gray-500">
          Validate report data integrity and ensure workflow efficiency.
        </p>
      </motion.div>
    </motion.div>
  );
